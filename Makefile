...
package-firefox: ## Package the firefox extension
	...
	sed -i "" -E "s/var hasDom = _exports\.hasDOM = typeof self === 'object' && self !== null && self\.Object === Object && typeof Window !== 'undefined' && self\.constructor === Window && typeof document === 'object' && document !== null && self\.document === document && typeof location === 'object' && location !== null && self\.location === location && typeof history === 'object' && history !== null && self\.history === history && typeof navigator === 'object' && navigator !== null && self\.navigator === navigator && typeof navigator\.userAgent === 'string'/var hasDom= _exports\.hasDOM = true/g" ./dist/staged/assets/vendor.js
	mkdir -p ./dist-packages
